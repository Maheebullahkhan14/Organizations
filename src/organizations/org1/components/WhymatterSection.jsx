  ...
  return (
    <div className="why-matters-main-cover-wrapper">
      ...
      <section className="relative py-20 px-4 md:px-20 w-[75%] overflow-hidden mx-auto">
        ...
        >
          <div
            className="flex justify-center items-center gap-2 text-orange-500 text-lg font-semibold"
          >
          ...
          <p className="text-center mt-4 text-gray-700">
            Explore the impact we create by championing <br /> youth rights and opportunities.
          </p>
        </div>
            ...
            >
              {i === 0 && (
                <div className="why-matters-banner-cover-box">
                  <div
                    className="whymatters-card-first-wrapper mb-2"
              ...
              {i === 1 && (
                <div className="h-[100%] relative rounded-3xl overflow-hidden group hover:scale-[1.02] transition-all duration-500 cursor-pointer">
                  <img
                    src={item.img}
                    alt={item.title}
              ...
              {i === 2 && (
                <div className="why-matters-banner-cover-box">
                  ...
                  <div
                    className="whymatters-card-first-wrapper mt-2"
                    style={{ backgroundColor: item.bg }}
                  >
                    <h5>{item.title}</h5>
                    <p>{item.desc}</p>
